                    ...
                    <Card containerStyle={{ padding: 0 }}>
                        <CardActions>
                            <TextField
                                ...
                                onBlur={this.firstShowError.bind(this)}
                                errorText={(this.state.FNameTextControl === false) ? "" : "First Name is required"}
                                name="firstName"
                                id="firstName"
                            ...
                            <TextField
                                ...
                                onBlur={this.lastNameShowError.bind(this)}

                                errorText={(this.state.LNameTextControl === false) ? "" : "Last Name is required"}
                                name="lastName"
                                onChange={this.changeHandler.bind(this)}
                            ...
                            <div style={{ marginTop: "5%" }} >
                                <RaisedButton
                                    ...
                                    label="Rigester"
                                    fullWidth={true}
                                    onClick={this.rigesterButton.bind(this)}
                                    primary={true} />
                            </div>
                            <Google_FB_Singin />
                        </CardActions>
